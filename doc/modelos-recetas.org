...
*** Condiciones fisicas (converged_model_thermo.py)

Se pueden graficar en funcion del radio de adimensional

En el modelo:

>> python ../../../converged_model_thermo.py modelo

lo que se obtiene es un archivo: modelo.png con la grafica de dichas condiciones fisicas.

*** Estructura ionica (converged-model-cum-emiss-plot.py)

Tambien puede ser graficada en funcion del radio adimensional del modelo
