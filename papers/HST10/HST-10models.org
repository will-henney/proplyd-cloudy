...
|        | N/H      |  7.48 | 7.845 |      3.02e-5 |         7e-5 |            0.432 |
|        | O/H      |  8.63 |   8.6 |      4.27e-4 |      3.98e-4 |             1.07 |
|        | Ne/H     |  7.75 |  7.78 |      5.62e-5 |     6.026e-5 |            0.933 |
|        | S/H      |  6.75 |   7.0 |     5.623e-6 |         1e-5 |           0.5623 |
...
+ This is the table of lines and corresponding FITS files that Yannis sent me. 

#+NAME: yiannis-brightness-maps
| [O II] 3726   | map3726sc_mask       |
| [Ne III] 3967 | map3967_L2mask       |
| H delta 4101  | map4101_L2mask       |
| C II 4267     | map4267_L2mask       |
| [O III] 4363  | map4363_L2mask       |
| [O III] 4959  | rub4959cubezero_mask |
| [N I] 5198    | rub5198_NI_L4        |
| [Fe III] 5270 | rub5270_FeIII_L4     |
| O I 5577      | rub5577_OI_L4        |
| [N II] 5755   | rub5755_L5sc         |
| He I 5776     | rub5876_L5sc         |
| [O I] 6300    | rub6300_OI_L5sc      |
| [S III] 6312  | rub6312_L5sc         |
| ?? 6578       | rub6578_L6sc         |
| [N II] 6584   | rub6584sc            |
| [S II] 6731   | rub6731sc            |
| [Ar III] 7136 | rub7136sc            |
| H alpha 6563  | scHa                 |

+ [ ] I do not know if they are dereddened or not - probably not
...
resultstab.append([
    "line", "S(prop)", "S(bg)", "dS1", "dS2", 
    "S(prop-bg)", "dS/S", "S(prop-bg)/S(bg)"
])
...
for emline, filename in linetab:
    ...
    print "{:15s}: head = {:.3f}, bg = {:.3f} +/- {:.3f} +/- {:.3f}".format(
        emline, head, meanbg, epsilon1, epsilon2
    )

    head_bg = head - meanbg
    epsfrac = np.sqrt(epsilon1**2 + epsilon2**2) / head_bg
    contrast = head_bg/meanbg
    print " BG-subtracted: {:.3f} +/- {:d}%".format(head_bg, int(100*epsfrac))
    print " Contrast with BG: {:.3f}".format(contrast)
    print

    resultstab.append([emline] + ["{:.3f}".format(v) for v in 
...
#+RESULTS:
| line          | S(prop) |   S(bg) |    dS1 |   dS2 | S(prop-bg) |  dS/S | S(prop-bg)/S(bg) |
| [O II] 3726   |  39.313 |  35.980 |  7.507 | 1.011 |      3.333 | 2.272 |            0.093 |
| [Ne III] 3967 |   2.626 |   2.471 |  0.078 | 0.030 |      0.155 | 0.537 |            0.063 |
| H delta 4101  |  17.423 |  13.156 |  1.088 | 0.089 |      4.267 | 0.256 |            0.324 |
| C II 4267     |   0.150 |   0.136 |  0.007 | 0.004 |      0.014 | 0.550 |            0.103 |
| [O III] 4363  |   0.718 |   0.580 |  0.011 | 0.006 |      0.138 | 0.092 |            0.238 |
| [O III] 4959  |  69.621 |  62.808 |  3.897 | 1.812 |      6.812 | 0.631 |            0.108 |
| [N I] 5198    |   0.127 |   0.074 |  0.025 | 0.012 |      0.053 | 0.524 |            0.723 |
| [Fe III] 5270 |   0.282 |   0.203 |  0.022 | 0.006 |      0.079 | 0.284 |            0.387 |
| O I 5577      |   0.325 |   0.305 |  0.002 | 0.004 |      0.020 | 0.192 |            0.066 |
| [N II] 5755   |   1.387 |   0.307 |  0.047 | 0.007 |      1.080 | 0.044 |            3.517 |
| He I 5776     |  11.953 |   8.849 |  0.614 | 0.048 |      3.105 | 0.198 |            0.351 |
| [O I] 6300    |   1.806 |   0.367 |  0.064 | 0.007 |      1.439 | 0.044 |            3.917 |
| [S III] 6312  |   1.569 |   1.109 |  0.062 | 0.010 |      0.460 | 0.137 |            0.415 |
| ?? 6578       |   0.236 |   0.178 |  0.024 | 0.005 |      0.058 | 0.426 |            0.325 |
| [N II] 6584   |  57.540 |  23.870 |  4.850 | 0.272 |     33.670 | 0.144 |            1.411 |
| [S II] 6731   |   4.201 |   2.719 |  0.689 | 0.052 |      1.483 | 0.466 |            0.545 |
| [Ar III] 7136 |  14.730 |   9.151 |  0.262 | 0.058 |      5.579 | 0.048 |            0.610 |
| H alpha 6563  | 281.358 | 193.199 | 13.292 | 1.181 |     88.158 | 0.151 |            0.456 |

So, in the results table the last 3 columns are the most interesting:

+ S(prop-bg) :: The background-subtracted mean proplyd brightness
+ dS/S :: The fractional uncertainty in S(prop-bg) due to the background
+ S(prop-bg)/S(bg) :: The contrast of the proplyd against the background
