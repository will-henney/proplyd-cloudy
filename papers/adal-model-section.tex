...
For all these parameters, we simply took best-determined values from the literature, rather than trying to adjust them to fit the current observations.  
The stellar spectrum is that determined for \thC{} by spectroscopic analysis \citep{2006AandA...448..351S}. 
The ionization front radius is the value determined by fitting to \textit{HST} emission line images \citep{1999AJ....118.2350H}, while the ionizing flux 
